---
description: Update all documentation for the current repository — README, docs/INDEX.md, and .github/copilot-instructions.md. Run with no arguments.
agent: doc-updater
---
...
Follow the full workflow defined in the `doc-updater` agent:
